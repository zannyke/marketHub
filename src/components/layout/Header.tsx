...
export const Header = () => {
    const { role, setRole, theme, toggleTheme, cartCount } = useApp();
            ...
            <div className="container mx-auto px-4 flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 ml-auto">
                    ...
                    <div className="relative" ref={menuRef}>
                        ...
                        >
                            <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-slate-200 to-slate-300 flex items-center justify-center text-slate-600 font-bold text-sm overflow-hidden">
                        ...
                        {/* Dropdown Menu */}
                        {isMenuOpen && (
                            <div className="absolute right-0 top-full mt-2 w-72 bg-white dark:bg-slate-900 rounded-xl shadow-xl border border-slate-100 dark:border-slate-800 overflow-hidden animate-in fade-in zoom-in-95 duration-200 origin-top-right z-50">
                                {/* User Info */}
                                <div className="p-4 border-b border-slate-50 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/50">
                                    ...
                                    <p className="text-xs text-slate-500 dark:text-slate-400 truncate">alex.j@example.com</p>
                                </div>
